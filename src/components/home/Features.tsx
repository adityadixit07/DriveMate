...
//           <FaUserShield className="text-blue-500 text-6xl mb-4" />
...
//         {/* Feature 2 */}
//         <div className="flex flex-col items-center text-center bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
//           <FaCalendarCheck className="text-green-500 text-6xl mb-4" />
//           <h3 className="text-2xl font-semibold text-gray-800 mb-2">
//             Convenient Booking
//           </h3>
//           <p className="text-gray-600">Book instantly or schedule for later.</p>
//         </div>

//         {/* Feature 3 */}
//         <div className="flex flex-col items-center text-center bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
//           <FaDollarSign className="text-yellow-500 text-6xl mb-4" />
//           <h3 className="text-2xl font-semibold text-gray-800 mb-2">
//             Affordable Rates
//           </h3>
//           <p className="text-gray-600">
...
//           </h3>
//           <p className="text-gray-600">
//             Stay updated on your driver’s location.
//           </p>
//         </div>
//       </div>
//     </section>
